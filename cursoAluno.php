            ...
            <div id="listaAlunos" class="listAlunos">
                ...
                <div class="form-group col-12 col-lg-6">
                    <form action="valida.php" method="POST">
                        <label for="curso">Cursos Disponíveis</label><br>
                            ...
                            <?php
                            echo "<a href='./listaAluno.php'  class='btn btn-success mr-2' style='background-color:blue;width:70px;height:40px;font-size:16px;color:white;margin-top:20px;margin-bottom:10px'>Voltar</a><input class='btn btn-success mr-2' type='submit' value='Enviar' name='alunoCurso'>
