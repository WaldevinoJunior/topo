        ...
        <div class="admin">
            ...
            <div id="func">
                ...
                <div class="cont-header" id="cbcLista">
                    ...
                    <a href="./mostraAfiliadosFranqueados.php" class="btn btn-primary btn-sm" style="background-color:blue;vertical-align:baseline;margin:0px;font-size:14px;">Voltar</a>
